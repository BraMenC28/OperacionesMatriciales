...
columnas=int(input("Ingrese el numero de columnas de la matriz numero 1: "))

matrizes.matriz_1 = [[0 for _ in range(columnas)] for _ in range(filas)]##se crea la matriz con los datos ingresados. (no importa el indice solo que gire por eso el "_")
...
columnas=int(input("Ingrese el numero de columnas de la matriz numero 2: "))



matrizes.matriz_2= [[0 for _ in range(columnas)] for _ in range(filas)]
...
matrizes.sumaMatriz(filas, columnas)
